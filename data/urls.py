...
urlpatterns = [
    ...
    path('search/full/get_more_cards_taxon', views.get_more_cards_taxon, name='get_more_cards_taxon'),
    path('search/full/get_focus_cards', views.get_focus_cards, name='get_focus_cards'),
    path('search/full/get_focus_cards_taxon', views.get_focus_cards_taxon, name='get_focus_cards_taxon'),
