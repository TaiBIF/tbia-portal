...
let var_dict = {'鲃': '[鲃䰾]', '䰾': '[鲃䰾]', '刺': '[刺刺]', '刺': '[刺刺]', '葉': '[葉葉]', '葉': '[葉葉]', '鈎': '[鈎鉤]', '鉤': '[鈎鉤]', '臺': '[臺台]', '台': '[臺台]', '螺': '[螺螺]', '螺': '[螺螺]', '羣': '[群羣]', '群': '[群羣]', '峯': '[峯峰]', '峰': '[峯峰]', '曬': '[晒曬]', '晒': '[晒曬]', '裏': '[裏裡]', '裡': '[裏裡]', '薦': '[荐薦]', '荐': '[荐薦]', '艷': '[豔艷]', '豔': '[豔艷]', '粧': '[妝粧]', '妝': '[妝粧]', '濕': '[溼濕]', '溼': '[溼濕]', '樑': '[梁樑]', '梁': '[梁樑]', '秘': '[祕秘]', '祕': '[祕秘]', '污': '[汙污]', '汙': '[汙污]', '册': '[冊册]', '冊': '[冊册]', '唇': '[脣唇]', '脣': '[脣唇]', '朶': '[朵朶]', '朵': '[朵朶]', '鷄': '[雞鷄]', '雞': '[雞鷄]', '猫': '[貓猫]', '貓': '[貓猫]', '踪': '[蹤踪]', '蹤': '[蹤踪]', '恒': '[恆恒]', '恆': '[恆恒]', '獾': '[貛獾]', '貛': '[貛獾]', '万': '[萬万]', '萬': '[萬万]', '两': '[兩两]', '兩': '[兩两]', '椮': '[槮椮]', '槮': '[槮椮]', '体': '[體体]', '體': '[體体]', '鳗': '[鰻鳗]', '鰻': '[鰻鳗]', '蝨': '[虱蝨]', '虱': '[虱蝨]', '鳞': '[鱗鳞]', '鱗': '[鱗鳞]', '鳊': '[鯿鳊]', '鯿': '[鯿鳊]', '鲨': '[鯊鲨]', '鯊': '[鯊鲨]', '鹮': '[䴉鹮]', '䴉': '[䴉鹮]', '鴴': '(行鳥|鴴)', '鵐': '(鵐|巫鳥)', '䱵': '(䱵|魚翁)', '䲗': '(䲗|魚銜)', '䱀': '(䱀|魚央)', '䳭': '(䳭|即鳥)', '鱼': '[魚鱼]', '魚': '[魚鱼]', '鹨': '[鷚鹨]', '鷚': '[鷚鹨]', '蓟': '[薊蓟]', '薊': '[薊蓟]', '黒': '[黑黒]', '黑': '[黑黒]', '隠': '[隱隠]', '隱': '[隱隠]', '黄': '[黃黄]', '黃': '[黃黄]', '囓': '[嚙囓]', '嚙': '[嚙囓]', '莨': '[茛莨]', '茛': '[茛莨]', '霉': '[黴霉]', '黴': '[黴霉]', '莓': '[苺莓]', '苺': '[苺莓]', '藥': '[葯藥]', '葯': '[葯藥]', '菫': '[堇菫]', '堇': '[堇菫]', '鲹': '[鰺鲹鯵]', '鰺': '[鰺鲹鯵]', '鯵': '[鰺鲹鯵]'}
...
function getVariants(text){
    ...
    for (t of text){
        ...
        } else if (Boolean(t.charAt(0).match(/[a-zA-Z]/)) ){
            new_string += `[${t.toUpperCase()}${t.toLowerCase()}]`
        } else {
            new_string += t
        }
    } 
